...
namespace Baz.Caja.Turnador.Service
{
    public class CjCRPoolService : CjCRServiceBase
    {
        ...
        {
            return PoolLogic.CambiaPuntoAtencion(noEmpleado, puntoatencion, credential);
        }

        public CjCREmpleadoPool Empleado(String noEmpleado, CjCRCredential credential)
        {

            return PoolLogic.GetEmpleado(noEmpleado, credential);
        }
