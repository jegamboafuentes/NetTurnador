...
namespace Baz.Caja.Turnador.Service.Ioc
{
    ...
    {   
        ...
        public CjCRSummary CambiaPuntoAtencion(String noEmpleado, String puntoatencion)
        {
            return PoolService.CambiaPuntoAtencion(noEmpleado, puntoatencion,
                PoolService.GetAuthorization(true));
        }


        public CjCREmpleadoPool Empleado(String noEmpleado)
        {
            return PoolService.Empleado(noEmpleado,
                PoolService.GetAuthorization(true));
